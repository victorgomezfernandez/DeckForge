        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body create-deck-modal-body">
                    <span class="modal-title w-100 text-center create-deck-modal-header" id="staticBackdropLabel">CREATE
                        NEW DECK</span>
                    <form action="{{ route('decks.store') }}" method="POST" class="create-deck-form">
                        @csrf
                        <div class="mb-3 w-100">
                            <label for="deck-name" class="form-label">Name</label>
                        ...
                        <button class="btn dropdown-toggle format-dropdown mb-3 w-100" type="button"
                            ...
                            <span id="selectedFormatLabel">Format</span>
                        </button>
                        ...
                        <button type="submit" class="btn btn-primary w-100 create-deck-modal-submit">CREATE</button>
                    </form>
                </div>
            </div>
        </div>
